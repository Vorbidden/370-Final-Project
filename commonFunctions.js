...
function changeSelectionText(selectedObjectName) {
    let color;
    if (selectedObjectName === "arm") {
        color = "purple";
    } else if (selectedObjectName === "finger0") {
        color = "red";
    } else {
        color = "green";
    }
    document.getElementById("selectionText").innerHTML = `Selection: <b style='color:${color}'>` + selectedObjectName + "</b>";
}