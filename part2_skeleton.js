...
function drawScene(gl, deltaTime, state) {
    ...
    state.objects.forEach((object) => {
        ...
        // Update uniforms
        {
            ...
            // translate (position), translate (centroid), rotate, translate(neg centroid)
            ...
            if (object.parent != null && getObjectByName(state, object.parent) != null) {
                var parent = getObjectByName(state, object.parent)
                mat4.multiply(modelMatrix, parent.modelMatrix, modelMatrix)
            }
